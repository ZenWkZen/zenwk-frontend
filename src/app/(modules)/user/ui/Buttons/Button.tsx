...
/**
 * Interface que representa los elmentos button para el módulo @user
 */
...
/**
 * Componente button con sporte para button loading con animación de anillo.
 * @param param0
 * @returns
 */
